  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        // Dark
        "dark:border-white/10 dark:bg-black/40 backdrop-blur-md dark:shadow-none",
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-2">
        <h3 className="font-semibold text-base text-zinc-900 tracking-tight dark:text-white">
          {item.title}
        </h3>
        <p className="text-sm text-zinc-500 leading-relaxed dark:text-zinc-300">
          {item.description}
        </p>
      </div>
